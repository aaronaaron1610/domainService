...
const App = () => {
    ...
    const mintDomain = async () => {
        ...
        const price =
            domain.length === 3 ? "0.010" : domain.length === 4 ? "0.010" : "0.010"
    ...
    const renderNotConnectedContainer = () => (
        <div className="connect-wallet-container">
            <img
                src="https://wowt.mypinata.cloud/ipfs/QmfVA5umoU91tDdm2QBX7gshXVvyjjc3NUGqqvhFX82wam"
                alt="Vibing Cat gif"
                width={178}
            />
            <button
        ...
        <div className="App">
            <div className="container">
                <div className="header-container">
                    <header>
                        <div className="left">
                            <p className="title">💫 Aaron Name Service💫</p>
